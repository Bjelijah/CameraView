...
public class YUVGLSurfaceView extends GLSurfaceView implements CamOpenOverCallback,PreviewCallback{
...
//					JniUtil.YUVsetData(yuv420, yuv420.length,w, h);
					...
					TestSocket.getInstance().sendPacket(mH264, h264Len);
